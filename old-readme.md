...
## Original Repo https://github.com/mdietrichstein/gradle-offline-dependencies-plugin.git
...
buildscript {
  ...
  dependencies {
    classpath 'gradle.plugin.com.dimaslanjaka.gradle.offline_dependencies:gradle-offline-dependencies-plugin:0.5.0'
  }
}

apply plugin: 'com.dimaslanjaka.gradle.offline_dependencies'
```
...
```
plugins {
  id 'com.dimaslanjaka.gradle.offline_dependencies' version '0.5.0'
}
```
...
# [Full Example Automatic Offline Dependencies (gradle)](init.d.gradle)