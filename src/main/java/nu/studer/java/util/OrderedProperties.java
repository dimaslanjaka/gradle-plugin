...
public class OrderedProperties implements Serializable {
	 ...
	 * the value of the property, or <b>null</b> if there was no property with
	 * the specified key.
	 *
	 * @param key the key of the property to remove
	 * @return the previous value of the property, or <b>null</b> if there was no property with the specified key
	 */
	...
	/**
	 * Returns <b>true</b> if there is a property with the specified key.
	 *
	...
	/**
	 * @param stream See {@link Properties#list(PrintStream)}.
	 */
	...
	/**
	 * @param writer See {@link Properties#list(PrintWriter)}.
	 */
	 ...
	 */
	public static class OrderedPropertiesBuilder {
	 ...
	 */
	private static class DateSuppressingPropertiesBufferedWriter extends BufferedWriter {
