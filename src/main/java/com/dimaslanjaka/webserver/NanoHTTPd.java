 ...
 *
 * <p> com.dimaslanjaka.webserver.NanoHTTPd version 1.22,
...
public class NanoHTTPd implements Runnable {
	...
	public NanoHTTPd(int port) throws IOException {
		...
		hostname = myServerSocket.getInetAddress().getCanonicalHostName();
	...
	public static void main(String[] args) {
		System.out.println("com.dimaslanjaka.webserver.NanoHTTPd 1.22 (C) 2001,2005-2011,2020 Jarno Elonen and (C) 2010 Konstantinos Togias\n" +
	...
	private class HTTPSession implements Runnable {
		...
		private String saveTmpFile(byte[] b, int offset, int len) {
			...
			if (len > 0) {
				...
				try {
					File temp = File.createTempFile("com.dimaslanjaka.webserver.NanoHTTPd", "", new File(tmpdir));
		...
		private void decodeParms(String parms, Properties p)
			...
			while (st.hasMoreTokens()) {
				...
				int sep = e.indexOf('=');
				p.put(
								Objects.requireNonNull(decodePercent((sep >= 0) ? e.substring(0, sep) : e)).trim(),
