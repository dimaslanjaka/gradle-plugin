...
/**
 * <p>com.dimaslanjaka.init.EasyDokka Class - class with gradle properties getters, thread-safe and a fast singleton
 * implementation.</p>
 *
...
final class EasyDokka {
    ...
    /**
     * Only method to get singleton object of com.dimaslanjaka.init.EasyDokka Class
     *
