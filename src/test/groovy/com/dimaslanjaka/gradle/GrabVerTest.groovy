...
class GrabVerTest {
    private Project project = ProjectBuilder.builder()
            .withProjectDir(new File("build/JUnit/GrabVerTest").absoluteFile)
            .withName("project name")
            .build()
    private Project subproject = ProjectBuilder.builder()
            .withProjectDir(new File("build/JUnit/GrabVerTest/sub").absoluteFile)
            .withName("project name")
            .build()
    public static final PLUGIN_ID = 'com.dimaslanjaka.gradle-plugin'
     ...
     */
    void printResults(String title) {
        println("TEST - " + title)
    ...
    static void simulateProperties(int major, int minor, int patch, int build, int code) {
