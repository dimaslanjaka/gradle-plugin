...
class StaticFileHandler implements HttpHandler {
     ...
     */
    StaticFileHandler(String urlPrefix, String filesystemRoot, String directoryIndex) {
     ...
     * @param directoryIndex File to show when a directory is requested, e.g. "index.html".
     */
    static void create(HttpServer hs, String path, String filesystemRoot, String directoryIndex) {
        StaticFileHandler sfh = new StaticFileHandler(path, filesystemRoot, directoryIndex)
        hs.createContext(path, sfh)
    }

    void handle(HttpExchange he) throws IOException {
    ...
    private static void sendError(HttpExchange he, int rCode, String description) throws IOException {
    ...
    private static void reportPathTraversal(HttpExchange he) throws IOException {
